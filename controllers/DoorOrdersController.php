...
use app\models\calculating\DoorOrderSearch;
...
class DoorOrdersController extends Controller
{
    ...
    {
        $searchModel = new DoorOrderSearch();
    ...
    {
        if(($model = CalculateDoor::findOne($id)) != false){
            if(in_array(Yii::$app->user->identity->type, ['admin', 'manager'])){
                return $model;
            }
